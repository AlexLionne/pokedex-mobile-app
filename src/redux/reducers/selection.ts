...
import {
    ...
    SET_FILTER_POKEMON_TYPES,
    SET_SELECTED_CAROUSEL_POKEMON,
...
const applicationReducer = (state: ISelectionStore = initialState, action: any) => {
    switch (action.type) {
        ...
        case SET_SELECTED_CAROUSEL_POKEMON:
            return {
                ...state,
                selectedCarouselPokemon: action.pokemon
            }
